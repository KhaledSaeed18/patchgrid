import { PROBLEM_TYPE_SLUGS, problemStatus, type ProblemTypeSlug } from "@patchgrid/contracts"
...
export type ProblemType = ProblemCopy & { readonly slug: ProblemTypeSlug; readonly status: number }
